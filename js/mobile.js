define([], function(){
    ...
    var reset = function() {
        //设定窗口比率
        radio = (document.body.scrollHeight||$(document).height())/(document.body.scrollWidth||$(window).height());
        //设定一页的宽度
        scaleW = document.body.scrollWidth||$(document).width();
        //设定初始的索引值
        idx = 0;
    };
    //第一步 -- 组合
    ...
    var renderDOM = function(){
        ...
        basicwrap = wrap;
        wrap.style.height = (document.body.scrollHeight||$(document).height()) + 'px';
    };
